            ...
            'handlers_perflog': [
                {
                    ...
                    'format': '%(check_job_completion_time)s|%(check_short_name)s|%(check_name)s|%(check_hashcode)s|%(check_system)s|%(check_partition)s|%(check_environ)s|jobid=%(check_jobid)s|num_nodes=%(check_num_nodes)s|num_task=%(check_num_tasks)s|num_tasks_per_node=%(check_num_tasks_per_node)s|num_gpus_per_node=%(check_num_gpus_per_node)s|%(check_perfvalues)s',
