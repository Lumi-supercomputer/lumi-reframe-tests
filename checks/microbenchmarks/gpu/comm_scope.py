...
class lumi_build_comm_scope(rfm.CompileOnlyRegressionTest):
    ...
    def do_cmake(self):
        ...
        self.build_system.config_opts = ['--fresh', '-DCMAKE_C_COMPILER=amdclang', '-DCMAKE_CXX_COMPILER=hipcc', '-DSCOPE_ARCH_MI250X=ON', '-DSCOPE_USE_NUMA=ON', '-DCMAKE_CXX_FLAGS="-D__HIP_PLATFORM_AMD__ -fopenmp"', '-DCMAKE_POLICY_VERSION_MINIMUM=3.5']
