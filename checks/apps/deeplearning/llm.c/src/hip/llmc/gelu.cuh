...
void gelu_forward(floatX* out, const floatX* inp, int N, hipStream_t stream) {
    //mNVTX_RANGE_FN();
...
void gelu_backward_inplace(floatX* d_in_out, const floatX* inp, const int N, hipStream_t stream) {
    //mNVTX_RANGE_FN();
